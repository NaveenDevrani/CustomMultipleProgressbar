package com.naveen.custommultpleprogressbars;
...
public class CustomProgressbar extends View {
    ...
    void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mBackgroundColor = a.getColor(R.styleable.CustomProgressbar_backgroundColor, android.R.color.darker_gray);
            mPrimaryProgressColor = a.getColor(R.styleable.CustomProgressbar_progressColor, android.R.color.darker_gray);
            mSecondaryProgressColor = a.getColor(R.styleable.CustomProgressbar_secondaryProgressColor, android.R.color.black);

            mProgress = a.getInt(R.styleable.CustomProgressbar_progress, 0);
            mSecodaryProgress = a.getInt(R.styleable.CustomProgressbar_secondaryProgress, 0);

            mStrokeWidth = a.getDimensionPixelSize(R.styleable.CustomProgressbar_strokeWidth, 20);
            mTextColor = a.getColor(R.styleable.CustomProgressbar_textColor, android.R.color.black);
            ...
            mIsPrimaryCapVisible = a.getBoolean(R.styleable.CustomProgressbar_primaryCapVisibility, true);
            mIsSecondaryCapVisible = a.getBoolean(R.styleable.CustomProgressbar_secodaryCapVisibility, true);
        } finally {
            a.recycle();
        }
